    ...
    <div className="bg-[#0D0D0D] text-white">
      ...
      <main className="container mx-auto px-4 py-20">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-lg text-gray-400">Tem alguma dúvida ou sugestão? Adoraríamos ouvir você.</p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 bg-[#1A1A1A] p-8 rounded-lg">
          <div>
            ...
            <form className="space-y-4">
              <Input type="text" placeholder="Seu nome" className="bg-[#2C2C2C] border-none h-12" />
              <Input type="email" placeholder="Seu e-mail" className="bg-[#2C2C2C] border-none h-12" />
              <Textarea placeholder="Sua mensagem" className="bg-[#2C2C2C] border-none" rows={6} />
              <Button size="lg" className="w-full bg-orange-500 hover:bg-orange-600 text-white font-bold h-12">
                ENVIAR MENSAGEM
              </Button>
            </form>
          </div>
            ...
            <ul className="space-y-4 text-gray-300">
              <li className="flex items-start gap-4">
                ...
                <span>
                  ...
                  <br />
                  Rua das Sneakers, 123, Vila Madalena, São Paulo - SP, CEP: 05435-000
                </span>
              </li>
              <li className="flex items-start gap-4">
